---
title: "Chapter9_Analisis Multivariado de las comunidades"
author: "CamilaSilva"
date: "8/19/2022"
output:
...
## Prueba de hipótesis entre grupos usando (PERMANOVA)

```{r}
setwd("home/csilva/R/Datasets&RCodes_Microbioma_R/Expo_IntroR")
```


## Implementando PERMANOVA usando el paquete vegan 
...
```{r}
adonis2(jaccard ~ Group,data=grouping,permutations = 1000) 
```

```{r}
adonis2(Sorensen ~ Group,data=grouping,permutations = 1000) 
```
adonis(bray ~ Location,data=grouping,permutations = 1000) 
adonis(jaccard ~ Location,data=grouping,permutations = 1000)
adonis(Sorensen ~ Location,data=grouping,permutations = 1000)
...
S?rensen<-vegdist(otu_table,binary=TRUE)
...
fit_S <- anosim(S?rensen, grouping, permutations = 1000)
summary(fit_S) 
################################################################################ 
